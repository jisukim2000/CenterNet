...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--data-cfg', type=str, default='/home/adasone/KJS/CenterNet/data/coco.data', help='coco.data file path')
  ...
  def init(self, args=''):
    default_dataset_info = {
      'ctdet': {'default_resolution': [480, 832], 'num_classes': 7, #512
